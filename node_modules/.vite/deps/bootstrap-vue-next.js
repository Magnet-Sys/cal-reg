  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        }, null, 8, _hoisted_213)) : createCommentVNode("", true),
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        }, toDisplayString(tags.value.join(", ")), 9, _hoisted_214),
        createBaseVNode("div", {
        ...
        renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(slotAttrs.value)), () => [
          ...
          createBaseVNode("div", {
            ...
            tags.value.length === unref(props).limit ? (openBlock(), createElementBlock("small", _hoisted_125, toDisplayString(unref(props).limitTagsText), 1)) : createCommentVNode("", true)
          ], 8, _hoisted_9)
        ]),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), {
        ...
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "prepend", {}, () => [
            hasPrepend.value ? (openBlock(), createElementBlock("span", _hoisted_127, [
              createBaseVNode("span", null, toDisplayString(unref(props).prepend), 1)
            ])) : createCommentVNode("", true)
          ]),
          renderSlot(_ctx.$slots, "default"),
          renderSlot(_ctx.$slots, "append", {}, () => [
            hasAppend.value ? (openBlock(), createElementBlock("span", _hoisted_215, [
...
// node_modules/bootstrap-vue-next/dist/BNavText.vue_vue_type_script_setup_true_lang-DTf8nxUN.mjs
...
var _sfc_main42 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", _hoisted_129, [
        renderSlot(_ctx.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(unref(props).text), 1)
        ])
      ]);
...
// node_modules/bootstrap-vue-next/dist/BNavbarToggle.vue_vue_type_script_setup_true_lang-BKfzvgvU.mjs
          ...
          return [
            createBaseVNode("div", mergeProps({ id: "__BVID__popover-container" }, _ctx.$attrs), [
              (openBlock(true), createElementBlock(Fragment, null, renderList(((_a = unref(tools).popovers) == null ? void 0 : _a.value.entries()) ?? [], ([
                ...
                return openBlock(), createBlock(resolveDynamicComponent(_component ?? (val.tooltip ? _sfc_main49 : _sfc_main2)), mergeProps({
                  key,
                  ref_for: true
                }, val, {
                  "initial-animation": "",
              ...
              return [
                ...
                isSortable.value && !!scope.field.sortable && unref(props).noSortableIcon === false ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ((_b = (_a = sortByModel.value) == null ? void 0 : _a.find((el) => el.key === scope.field.key)) == null ? void 0 : _b.order) === "asc" ? renderSlot(
                    ...
                    () => [
                      (openBlock(), createElementBlock("svg", _hoisted_134, _cache[7] || (_cache[7] = [
                        createBaseVNode("path", {
                          "fill-rule": "evenodd",
                          d: "M8 12a.5.5 0 0 0 .5-.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 .5.5z"
                        }, null, -1)
        ...
        default: withCtx(() => {
          ...
          return [
            withDirectives(createBaseVNode("div", {
              ...
              unref(contentShowing) && (slots.default || unref(props).body) ? (openBlock(), createElementBlock("div", _hoisted_221, [
                (openBlock(), createBlock(resolveDynamicComponent(computedTag.value), mergeProps({
